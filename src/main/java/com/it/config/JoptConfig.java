...
public class JoptConfig {
    ...
    private ArgumentAcceptingOptionSpec<String> memberPropertiesOpt = parser
            .accepts("memberProp", "member properties file").withOptionalArg()
            .ofType(String.class).defaultsTo(DEFAULT_MEMBER_PROPERTIES);
    private ArgumentAcceptingOptionSpec<String> mailPropertiesOpt = parser
            .accepts("mailProp", "mail properties file").withOptionalArg()
            .ofType(String.class).defaultsTo(DEFAULT_MAIL_PROPERTIES);
    ...
    private void loadJoptOptions(String[] args) {
        ...
        MemberConfig.getInstance().setPropertiesFile(
                options.valueOf(memberPropertiesOpt));
        MailConfig.getInstance().setPropertiesFile(
                options.valueOf(mailPropertiesOpt));
